...
class FieldBuilder {
    ...
    public function text( $name, array $properties = array() ){
        ...
        return $this->make( 'Cuisine\\Field\\Fields\\TextField', $name, $properties );
    ...
    public function password( $name, array $properties = array() ){
        ...
        return $this->make( 'Cuisine\\Field\\Fields\\PasswordField', $name, $properties );
    }
    ...
    public function number($name, array $properties = array()){
        ...
        return $this->make( 'Cuisine\\Field\\Fields\\NumberField', $name, $properties );
    ...
    public function date($name, array $properties = array()){
        ...
        return $this->make( 'Cuisine\\Field\\Fields\\DateField', $name, $properties );
    ...
    public function textarea($name, array $properties = array()){
        ...
        return $this->make( 'Cuisine\\Field\\Fields\\TextareaField', $name, $properties);
    ...
    public function checkbox($name, $options, array $properties = array()){
        ...
        return $this->make('Cuisine\\Field\\Fields\\CheckboxField', $name, $properties );
    ...
    public function checkboxes($name, array $options, array $properties = array()){
        ...
        return $this->make( 'Cuisine\\Field\\Fields\\CheckboxesField', $name, $properties );
    }
    ...
    public function radio($name, array $options, array $properties = array()){
        ...
        return $this->make( 'Cuisine\\Field\\Fields\\RadioField', $name, $properties );
    }
    ...
    public function select( $name, array $options, $multiple = false, array $properties = array() ){
        ...
        return $this->make( 'Cuisine\\Field\\Fields\\SelectField', $name, $properties );
    }
    ...
    public function media($name, array $properties = array()){
        ...
        return $this->make( 'Cuisine\\Field\\Fields\\MediaField', $name, $properties );
    }
    ...
    public function repeater($name, array $fields, array $properties = array()){
        ...
        return $this->make( 'Cuisine\\Field\\Fields\\InfiniteField', $name, $properties );
    }
    ...
    public function flex($name, array $fields, array $properties = array()){
        ...
        return $this->make( 'Cuisine\\Field\\Fields\\FlexField', $name, $properties );
    }
